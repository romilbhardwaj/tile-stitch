...
stitch: stitch.c
	$(CC) -g -Wall -O3 $(CFLAGS) $(LDFLAGS) -o stitch stitch.c $(CURL_CFLAGS) $(PNG_CFLAGS) $(JPEG_CFLAGS) $(CURL_LIBS) $(PNG_LIBS) $(JPEG_LIBS) -ljpeg -lm -lgeotiff -ltiff -I /usr/include/geotiff
